      ...
      <div className="w-full px-4 sm:px-6 md:px-12 lg:px-16 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="https://status.stackryze.com/" target="_blank" className="text-[#1A1A1A] hover:text-[#FF6B35] transition-colors duration-150 font-medium text-sm lg:text-base">
              Status
            </a>
